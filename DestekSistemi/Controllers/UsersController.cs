...
namespace DestekSistemi.Controllers
{
    public class UsersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            // Eskisi: new SelectList(_context.Roles, "Id", "Id");
            // Yenisi: new SelectList(_context.Roles, "Id", "RoleName"); -> Artık İsim görünecek
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Password,RoleId")] User user)
        {
            ...
            // Hata olursa liste tekrar dolarken de İsim görünsün:
